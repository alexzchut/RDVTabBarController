...
static const unsigned componentFlags = (NSCalendarUnitYear| NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitWeekdayOrdinal |  NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond | NSCalendarUnitWeekday | NSCalendarUnitWeekOfMonth | NSCalendarUnitWeekOfYear);
...
- (NSString *)longFormattedStringFromDate {
    ...
    [outputFormatter setDateFormat:[NSString stringWithFormat:@"d'%@' MMM 'at' h:mma", [self daySuffixForDate:day]]];
